 ...
 * room. The room to destroy must be specified in the TO attribute of the IQ
 * packet. The server will send a presence unavailable together with the
 * alternate room and reason for the destruction to all the room occupants
 * before destroying the room.
 * <p>
 * 
 * When destroying a room it is possible to provide an alternate room which may
 * be replacing the room about to be destroyed. It is also possible to provide a
...
public class DestroyRoom extends IQ {
	...
	/**
	 * Creates a new DestroyRoom with the reason for the destruction and an
	 * alternate room JID.
	 * 
	 * @param alternateJID
	 *            JID of the alternate room or <tt>null</tt> if none.
	 * @param reason
