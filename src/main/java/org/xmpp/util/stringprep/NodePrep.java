 ...
 * 
 * see RFC3920:3.3 see RFC3920:Appendix A see
...
public class NodePrep extends StringPrep {
	 ...
	 */
	public static String prepare(final String node) throws StringPrepViolationException {
	...
	protected Set<String> buildProhibitedSet() {
		final Set<String> prohibited = super.buildProhibitedSet();
